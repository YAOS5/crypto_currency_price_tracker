...
let modulePaths = {
 ...
 "packages/bitcoin_ticker/main": "packages/bitcoin_ticker/main.ddc",
 "packages/bitcoin_ticker/main_web_entrypoint": "packages/bitcoin_ticker/main_web_entrypoint.ddc",
 "packages/bitcoin_ticker/price_screen": "packages/bitcoin_ticker/price_screen.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/bitcoin_ticker/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:bitcoin_ticker/main_web_entrypoint.dart") {
          // Clear static caches.

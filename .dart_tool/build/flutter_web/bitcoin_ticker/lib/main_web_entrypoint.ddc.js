define(['dart_sdk', 'packages/bitcoin_ticker/main'], function(dart_sdk, packages__bitcoin_ticker__main) {
  'use strict';
  ...
  const main = packages__bitcoin_ticker__main.main;
  ...
  dart.trackLibraries("packages/bitcoin_ticker/main_web_entrypoint", {
    "package:bitcoin_ticker/main_web_entrypoint.dart": main_web_entrypoint
  }, {
